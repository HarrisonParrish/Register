...
// Build the participant template to insert into form
...
function successTemplate (info) {
    return`<p>
    Thank you ${info.adultName}! You have registered ${info.numberOfParticipants} 
    participants which will cost $${info.feeTotal} in fees.
    </p>`
}
